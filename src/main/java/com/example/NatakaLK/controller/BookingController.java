...
public class BookingController {
    ...
    public ResponseEntity<PaymentInitResponseDTO> addBooking(@RequestBody BookingRequestDTO reqDTO) {
        return ResponseEntity.ok(bookingService.addBooking(reqDTO));
    }

    @PutMapping("/cancel")
    @PreAuthorize("hasRole('Customer')")
    public ResponseEntity<String> cancelBooking(@RequestParam int bookingId, @RequestParam int customerId) {
